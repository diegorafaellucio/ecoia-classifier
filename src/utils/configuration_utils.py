...
class ConfigurationUtils:
    ...
    config_dict = {
        ...
        ConfigurationEnum.SIDE_A_SHAPE_PREDICTOR_WEIGHTS_FILE_PATH.name: 'data/models/cuts/model_A.dat',
        ConfigurationEnum.SIDE_B_SHAPE_PREDICTOR_WEIGHTS_FILE_PATH.name: 'data/models/cuts/model_B.dat',
        ...
        ConfigurationEnum.GENERATE_WATERMARK.name: 0,
