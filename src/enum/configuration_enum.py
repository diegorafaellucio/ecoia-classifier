...
class ConfigurationEnum(Enum):
    ...
    HUMP_CLASSIFICATION_WEIGHTS_PATH = ('HUMP_CLASSIFICATION_WEIGHTS_PATH', 'data/models/hump/weights.pt')
    HUMP_CLASSIFICATION_APPROACH = ('HUMP_CLASSIFICATION_APROACH', DetectionApproachEnum.ULTRALYTICS.value)

    BREED_CLASSIFICATION_WEIGHTS_PATH = ('BREED_CLASSIFICATION_WEIGHTS_PATH', 'data/models/breed/weights.pt')
    ...
    INTEGRATOR_MAX_WORKERS = ('MAX_WORKERS', 10)
    ...
    MODULE_HUMP_PREDICTION = ('MODULE_HUMP_PREDICTION', True)

    MODULE_BREED_PREDICTION = ('MODULE_BREED_PREDICTION', True)
