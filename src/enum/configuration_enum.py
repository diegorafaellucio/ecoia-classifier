...
class ConfigurationEnum(Enum):
    ...
    MEAT_CLASSIFIER_MODULE_IS_ACTIVE = ('MEAT_CLASSIFIER_MODULE_IS_ACTIVE', True)
    ...
    INTEGRATOR_MODULE_IS_ACTIVE = ('INTEGRATOR_MODULE_IS_ACTIVE', True)
    ...
    MEAT_CLASSIFIER_MAX_WORKERS = ('MAX_WORKERS', 10)
