...
class ConfigurationEnum(Enum):
    ...
    SKELETON_DETECTION_CONFIDENCE_THRESHOLD = ('SKELETON_DETECTION_CONFIDENCE_THRESHOLD', 0.87)
    ...
    MODULE_EXTENSION_LESION = ('MODULE_EXTENSION_LESION', False)
    ...
    REPROCESS_RETROACTIVE_DAYS = ('REPROCESS_RETROACTIVE_DAYS', False)
