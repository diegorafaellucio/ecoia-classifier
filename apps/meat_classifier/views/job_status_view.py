...
class JobStatusView(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        meat_classifier_job_thread = kwargs['meat_classifier_job_thread']

        meat_classifier_job_thread, message = JobThreadUtils.resurrect_thread(meat_classifier_job_thread, JobNameEnum, MeatClassifierJob.do)
